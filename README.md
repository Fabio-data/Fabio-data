...
- 📊 **Analista de Datos** con experiencia en SQL, Power BI, Python y automatización de procesos.
- 🤖 En el lado de **ciencia de datos**: machine learning y forecasting (scikit-learn, LightGBM).
- 🎓 Estudiando **Ingeniería en Ciencia de Datos** · Certificación **IBM Data Science**.
- 🌎 Medellín, Colombia · abierto a nuevas oportunidades.
- 💬 Pregúntame sobre **dashboards, ETL, modelado predictivo y storytelling con datos**.

```python
class Fabio:
    rol        = ["Analista de Datos", "Científico de Datos"]
    stack      = ["Python", "SQL", "Power BI", "LightGBM"]
    enfoque    = "datos accionables → decisiones de negocio"
    aprendiendo = "MLOps y despliegue de modelos"
```
...
<p align="center"><i>"Los datos cuentan historias; mi trabajo es que lleven a decisiones."</i></p>
